...
const services = [
    {
        ...
        desc: 'رؤية تحليلية دقيقة لمشاريع الحبوب والأعلاف واشجار الزيتون قبل التنفيذ، مع تقييم شامل للمخاطر وفرص النمو المستدام.',
        icon: BarChart3,
    },
    {
    ...
    },
    {
        ...
        desc: 'تنظيم مراحل ما بعد الحصاد والتخزين والنقل لضمان جودة الحبوب والأعلاف واشجار الزيتون ورفع القيمة التجارية في الأسواق.',
        icon: Sprout,
    },
]
            ...
            <div className="container">
                <div className="services-header-simple">
                    ...
                    <p className="section-lead">
                        نقدم حزمة متكاملة تغطي دورة إنتاج الحبوب والأعلاف واشجار الزيتون من التخطيط وحتى
